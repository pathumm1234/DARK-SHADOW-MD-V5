...
const song = async (_0x937ef9, _0x3d5042) => {
  ...
  if (_0x28a24b.includes(_0x3c966a)) {
          ...
          'message': {
            ...
            'interactiveMessage': proto.Message.InteractiveMessage.create({
              ...
              'footer': proto.Message.InteractiveMessage.Footer.create({
                'text': "© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅᴀʀᴋ-ꜱʜᴀᴅᴏᴡ-ᴍᴅ"
              }),
    ...
    if (_0x45cdbe) {
      const _0x21e728 = _0x45cdbe.startsWith("🎵audio_");
      const _0x56a36b = parseInt(_0x45cdbe.replace(_0x21e728 ? "🎵audio_" : "🎦video_", ''));
        ...
        try {
          ...
          if (_0x5784ae.ok) {
            ...
            if (_0x21e728) {
              ...
              _0xa3cc62.contextInfo.externalAdReply.title = "↺ |◁   II   ▷|   ♡";
